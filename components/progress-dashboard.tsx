...
export function ProgressDashboard() {
  ...
  return (
    <main className="progress-shell">
      ...
      {primary && <section className="current-priority"><div><div className="section-label">Current coaching priority</div><h2>{primary.label}</h2><p>{primary.interpretation}</p></div><SignalCard signal={primary} concise /></section>}
