...
export const PRACTICE_QUESTIONS: PracticeQuestion[] = [
  ...
  { id: "practice-spa-10", category: "Spatial", prompt: "Which option completes the matrix?", choices: ["■", "■■", "■■■", "□□□", "●●●"], targetSeconds: 22, difficulty: 2, skill: "figure matrices", stimulus: { kind: "matrix", title: "Complete the missing cell", rows: [["○", "○○", "○○○"], ["■", "■■", "?"]] } },
  { id: "practice-spa-11", category: "Spatial", prompt: "In each row, the third cell combines the first two. Which option completes the matrix?", choices: ["□", "■", "□■", "○●", "■■"], targetSeconds: 28, difficulty: 3, skill: "figure matrices", stimulus: { kind: "matrix", title: "Complete the missing cell", rows: [["○", "●", "○ ●"], ["□", "■", "?"]] } },
  { id: "practice-spa-12", category: "Spatial", prompt: "In each row, rotate the first symbol 90° clockwise, then place it before the second. Which option completes the matrix?", choices: ["←□", "↑□", "→□", "↓□", "□↑"], targetSeconds: 34, difficulty: 5, skill: "figure matrices", stimulus: { kind: "matrix", title: "Complete the missing cell", rows: [["↑", "○", "→ ○"], ["←", "□", "?"]] } },
