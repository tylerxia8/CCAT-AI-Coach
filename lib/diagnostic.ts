...
export const QUESTIONS: Question[] = [
  ...
  { id: "ver-14", category: "Verbal", prompt: "In how many rows does the entry on the left exactly match the entry on the right?", choices: ["1", "2", "3", "4", "5"], difficulty: 2, targetSeconds: 18, itemFamily: "attention to detail", stimulus: { kind: "pairs", title: "Compare each row", pairs: [["8RK-41M-762", "8RK-41M-762"], ["Q5B-903-X17", "Q5B-930-X17"], ["6TN-28C-445", "6TN-28G-445"], ["LP4-771-Z09", "LP4-771-Z09"], ["3DV-618-K52", "3DV-681-K52"]] } },
