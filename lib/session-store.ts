...
export const SESSION_STORAGE_KEY = "aptitude-coach:diagnostic:v3";
export const LEGACY_SESSION_STORAGE_KEYS = ["aptitude-coach:diagnostic:v1", "aptitude-coach:diagnostic:v2"] as const;
